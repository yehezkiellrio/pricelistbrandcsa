...
export default function Dashboard() {
  ...
  const withProgram = products.filter((product) => product.program_price !== null).length;
  const brandCounts = brands
    .map((brand) => ({ brand, count: products.filter((product) => product.brand === brand).length }))
  ...
  return <div className="shell page-stack dashboard">
    <section className="hero">
      ...
      <div className="hero-actions"><a className="button primary" href="/master-harga">Cari harga</a><a className="button secondary" href="/kalkulator">Kalkulator</a><OfflineManager /></div>
    </section>
    <CatalogStatus />
